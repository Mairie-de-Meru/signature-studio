...
window.IMAGE_BANK = {
  "categories": [
    ...
    {
      "id": "mairies",
      "label": "Hôtels de ville",
      "description": "Images libres de droits (Wikimedia Commons, bannière).",
      "images": [
        {
          "file": "assets/images/banks/mairies/meru-mairie-facade.jpg",
          "alt": "Mairie de Méru — façade",
          "slot": "banner",
          "license": "Source : Google Maps",
          "source": "https://ville-meru.fr/"
        },
        {
          "file": "assets/images/banks/mairies/meru-services-adresses-horaires.jpg",
          "alt": "Adresses et horaires des services — Méru",
          "slot": "banner",
          "license": "Source : ville-meru.fr",
          "source": "https://ville-meru.fr/"
        },
        {
          "file": "assets/images/banks/mairies/meru-square-mullot.jpg",
          "alt": "Square Mullot — Méru",
          "slot": "banner",
          "license": "Source : ville-meru.fr",
          "source": "https://ville-meru.fr/"
        }
